 ...
 *  
 */
public class Module9OverloadMethods {
    
    public static void main(String[] args) {
        double [] numbers = { 89.2, 45.1, 23.9, 20.2, 33.0, 45.6 };
    
        short avg1 = (short) (Module9OverloadMethods.average( numbers));
        int avg2 = (int) (Module9OverloadMethods.average( numbers));
        long avg3 = (long) (Module9OverloadMethods.average( numbers));
        double avg4 = (double) (Module9OverloadMethods.average( numbers));
